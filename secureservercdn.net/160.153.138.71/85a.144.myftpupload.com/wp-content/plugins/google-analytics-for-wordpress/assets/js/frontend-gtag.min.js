...
var MonsterInsights = function() {
        ...
        function b(e) {
            var h = c(),
                ...
                m = e.pathname;
            g = g.toString();
            var s, b, y = e.getAttribute('data-vars-ga-category');
            if (y) {
                return y
            };
            if (g.match(/^javascript\:/i)) {
                ...
                var w = i.length;
                for (var n = 0; n < w; n++) {
                    if (i[n].path && i[n].label && i[n].path.length > 0 && i[n].label.length > 0 && m.startsWith(i[n].path)) {
        ...
        function g(i) {
            ...
            e.el = o;
            e.click_type = m(i);
            if ('undefined' === typeof __gtagTracker || !p(i)) {
                e.exit = 'loaded';
                n(e);
                return
            }
            ...
            if (o && o.href && !o.hasAttribute('xlink:href')) {
                var x = o.href,
                    ...
                    r = b(o),
                    T = y(o, i),
                    k = o.getAttribute('data-vars-ga-action'),
                    g = o.getAttribute('data-vars-ga-label');
                e.el = o;
                e.el_href = o.href;
                    ...
                    if (T || r == 'mailto' || r == 'tel') {
                        if (r == 'download') {
                            l = {
                                ...
                                event_label: g || e.title,
                            }
                        } else if (r == 'tel') {
                            l = {
                                event_category: 'tel',
                                event_label: g || e.title.replace('tel:', ''),
                            }
                        } else if (r == 'mailto') {
                            console.log(g || e.title.replace('mailto:', ''));
                            l = {
                                event_category: 'mailto',
                                event_label: g || e.title.replace('mailto:', ''),
                            }
        ...
        function v() {
            if (monsterinsights_frontend.hash_tracking === 'true' && l != window.location.hash && monsterinsights_frontend.ua) {
