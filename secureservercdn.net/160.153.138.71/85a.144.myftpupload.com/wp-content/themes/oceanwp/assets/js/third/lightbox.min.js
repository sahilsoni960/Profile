...
function oceanwpInitLightbox(a) {
    ...
    }), $j(".gallery-format, .gallery", a).magnificPopup({
...
$j(document).ready(function() {
    "use strict";
    oceanwpAutoLightbox(), oceanwpInitLightbox()
});